...
export default function ResumeEditor({ resume: propsResume, userId }) {
  ...
  const combinedData = useMemo(
    ...
    [resumeDetails, experiences, projects, educationList, certifications]
  );
  const debouncedData = useDebounce(combinedData, 300);
  ...
  useEffect(() => {
    if (propsResume) {
      setResumeDetails({
        ...
        skills: propsResume.skills || resumeDetails.skills,
      });
    ...
    <div className="resume-editor-container">
      ...
      <div className="template-selector-header">
        <div className="template-selector-content">
          <h2 className="template-selector-title">Resume Builder</h2>
        ...
        <div className="editor-panel">
          <div className="ats-resume" ref={resumeRef}>
            ...
            <section className="section">
              ...
              <textarea className="skills-text"
                value={resumeDetails.skills}
                onChange={(e) => handleResumeDetailChange("skills", e.target.value)} />
            </section>
